...
import (
	...
	opts "gx/ipfs/QmTktQYCKzQjhxF6dk5xJPRuhHn3JBiKGvMLoiDy1mYmxC/go-libp2p-kad-dht/opts"
	pb "gx/ipfs/QmTktQYCKzQjhxF6dk5xJPRuhHn3JBiKGvMLoiDy1mYmxC/go-libp2p-kad-dht/pb"
	providers "gx/ipfs/QmTktQYCKzQjhxF6dk5xJPRuhHn3JBiKGvMLoiDy1mYmxC/go-libp2p-kad-dht/providers"
...
func (dht *IpfsDHT) findMasterPeerSingle(ctx context.Context, p peer.ID, id peer.ID) (*pb.Message, error) {
	...
	pmes := pb.NewMessage(pb.Message_FIND_MASTER_NODE, string(id), 0)
	resp, err := dht.sendRequest(ctx, p, pmes)
	switch err {
	case nil:
		return resp, nil
