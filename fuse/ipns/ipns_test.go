...
import (
	...
	racedet "gx/udfs/Qmf7HqcW7LtCi1W8y2bdx2eJpze74jkbKqpByxgXikdbLF/go-detect-race"
)
...
func setupIpnsTest(t *testing.T, node *core.UdfsNode) (*core.UdfsNode, *mountWrap) {
